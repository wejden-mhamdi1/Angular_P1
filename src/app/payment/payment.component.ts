...
import { AbonnementModule } from '../Model/abonnement/abonnement.module';
...
export class PaymentComponent implements OnInit {
  ...
  modalRef: BsModalRef;
    ...
    constructor(private service :AbonnementService,private modalService: BsModalService) { } //
  
    ngOnInit(): void {
    this.test= this.service.returnData();
    this.price=this.test?.prix;
    ...
    $(function(){
      ...
      //Card number input
      $(".number").keyup(function(this:any,event:any){
      ...
      }).on("keydown input", function(this:any){
      ...
      //Name Input
      $(".inputname").keyup(function(this:any){  
      ...
      //Date expire input
      $(".expire").keypress(function(this:any ,event:any){
        ...
        return false;
        //The key is released
      }).keyup(function(this:any,event:any){
